...
int main()
{
  ...
  std::cout << "ptr1 addr deserialized i    : " << Serialize::deserialize(i) << std::endl;
  std::cout << "ptr1 addr deserialized j    : " << Serialize::deserialize(j) << std::endl;
  ...
  std::cout << "ptr2 addr deserialized i    : " << Serialize::deserialize(i) << std::endl;
  std::cout << "ptr2 addr deserialized j    : " << Serialize::deserialize(j) << std::endl;
}
